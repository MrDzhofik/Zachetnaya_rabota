...
ActiveRecord::Schema[7.0].define(version: 2023_01_13_144142) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "favorsb", default: "Не выбрана"
    t.integer "guest", default: 0
    t.string "image_url", default: "https://img.freepik.com/premium-vector/boy-profile-photo-icon-women-portraits-user-photo_750364-583.jpg?w=740"
