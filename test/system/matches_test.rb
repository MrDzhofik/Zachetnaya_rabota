...
class MatchesTest < ApplicationSystemTestCase
  ...
  test "should create match" do
    ...
    fill_in "Schet", with: @match.schet
    check "Shotout" if @match.shotout
    fill_in "Sop", with: @match.sop
    fill_in "Statistic", with: @match.statistic
    fill_in "Style", with: @match.style
